...
Extract from $ARGUMENTS:
    ...
    - months - integer, how many past months to spread them accross

If any arument is missing or not a valid integer, stop and say: 
"Usage: /seed-expenses <user_id> <count> <months>
Example: /seed-expenses 1 50 6"

## Step 2 - Verify user exists

Before genberating anything, confirm the user_id exists in the users table. 
...
1. Spreads expenses randomly accross the past <months> months.
...
6. Inserts all expenses in a single transaction - roll back everytthing if any insert fails
